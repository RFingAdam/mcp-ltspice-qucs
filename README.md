...
The [HaLow LPF example](examples/halow_lpf/) finalizes a 7th-order
elliptic low-pass filter for an 802.11ah HaLow + LTE + WiFi + BLE + GNSS
device, hitting all 8 coex spec targets with >85% Monte-Carlo yield at
5% component tolerance — entirely through MCP tool calls.
